...
public class FileInfo implements java.lang.Comparable, Cloneable {
	...
	/**
	 * Returns last played date in "yyyy-MM-dd HH:mm:ss" format, translated to
	 * local time.
	 *
	 * @return
	 */
	...
	/**
	 * Returns added date date in "yyyy-MM-dd HH:mm:ss" format, translated to
	 * local time.
	 *
	 * @return
	 */
	...
	/**
	 * Overring method for sorting by relativeFullPath, for comparison during
	 * scan
	 *
	 * @param o
	 * @return
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof FileInfo) {
			...
			//FIXME Z MERGE Compare idFile instead of relativeFullPath
