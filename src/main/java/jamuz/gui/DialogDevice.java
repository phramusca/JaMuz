...
public class DialogDevice extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jButtonSelectDest.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/folder_explore.png"))); // NOI18N
        ...
        jButtonSelectSource.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/folder_explore.png"))); // NOI18N
	...
	private void jButtonSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSaveActionPerformed
		...
		if(name.isBlank() || source.isBlank() || destination.isBlank()) {  //NOI18N
			...
			if(Jamuz.getDb().device().insertOrUpdate(this.device)) {
				this.dispose();
