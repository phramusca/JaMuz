...
//		setLocationAndRootPath();
    ...
    private void initComponents() {
        ...
        jButtonAuto.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/arrow_refresh.png"))); // NOI18N
...
//			if(this.myStatSource.check()) {
				if(Jamuz.getDb().statSource().insertOrUpdate(this.statSource)) {
					this.dispose();
