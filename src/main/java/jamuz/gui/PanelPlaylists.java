...
public class PanelPlaylists extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jCheckBoxTranscode = new javax.swing.JCheckBox();
        ...
        jComboBoxPlaylist.setMaximumRowCount(50);
        ...
        jButtonPlaylistNew.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/add.png"))); // NOI18N
        ...
        jButtonPlaylistEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/application_form_edit.png"))); // NOI18N
        ...
        jButtonPlaylistSave.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/accept.png"))); // NOI18N
        ...
        jButtonPlaylistDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/bin.png"))); // NOI18N
        ...
        jButtonPlaylistCancel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/cancel.png"))); // NOI18N
        ...
        jButtonPlaylistFieldAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/add.png"))); // NOI18N
        ...
        jButtonPlaylistFilterDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/bin.png"))); // NOI18N
        ...
        jButtonPlaylistFilterEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/application_form_edit.png"))); // NOI18N
        ...
        jButtonPlaylistOrderAdd.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/add.png"))); // NOI18N
        ...
        jButtonPlaylisOrderDelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/bin.png"))); // NOI18N
        ...
        jButtonPlaylistOrderEdit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/application_form_edit.png"))); // NOI18N
        ...
        jCheckBoxTranscode.setText("Transcode to MP3 ? (Server sync)");
        jCheckBoxTranscode.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jCheckBoxTranscodeActionPerformed(evt);
            }
        });
        ...
        jPanelPlaylistLimitLayout.setHorizontalGroup(
            ...
            .addGroup(jPanelPlaylistLimitLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanelPlaylistLimitLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelPlaylistLimitLayout.createSequentialGroup()
                    ...
                    .addGroup(jPanelPlaylistLimitLayout.createSequentialGroup()
                        .addComponent(jCheckBoxTranscode)
                        .addGap(0, 0, Short.MAX_VALUE)))
                .addContainerGap())
        );
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jSplitPanePlaylist, javax.swing.GroupLayout.Alignment.TRAILING)
        );
    ...
    private void jComboBoxPlaylistActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxPlaylistActionPerformed
		if (jComboBoxPlaylist.getSelectedIndex() > 0 && enableComboListner) {		
			...
			jCheckBoxTranscode.setSelected(playlist.isTranscode());
...
//			            jComboBoxPlaylistType.setSelectedItem(playlist.type);
    ...
    private void jButtonPlaylistSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPlaylistSaveActionPerformed
        ...
        if(!newName.equals(playlist.getName())) {                
            ...
            } else if (!newName.isBlank()) {  //NOI18N
    ...
    private void jCheckBoxTranscodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCheckBoxTranscodeActionPerformed
        Playlist playlist = (Playlist) jComboBoxPlaylist.getSelectedItem();
        playlist.setTranscode(jCheckBoxTranscode.isSelected());
    }//GEN-LAST:event_jCheckBoxTranscodeActionPerformed
...
//            jListPlaylistFilters.setModel(new DefaultListModel(playlist.getFilters().toArray()));
    ...
    private javax.swing.JCheckBox jCheckBoxTranscode;
