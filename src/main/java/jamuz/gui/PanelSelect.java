...
public class PanelSelect extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jSplitPaneSelect.setDividerLocation(380);
        ...
        jCheckBoxSelectRating1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/1starU.png"))); // NOI18N
        jCheckBoxSelectRating1.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/1starC.png"))); // NOI18N

        jCheckBoxSelectRating2.setSelected(true);
        jCheckBoxSelectRating2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/2starU.png"))); // NOI18N
        jCheckBoxSelectRating2.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/2starC.png"))); // NOI18N

        jCheckBoxSelectRating3.setSelected(true);
        jCheckBoxSelectRating3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/3starU.png"))); // NOI18N
        jCheckBoxSelectRating3.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/3starC.png"))); // NOI18N

        jCheckBoxSelectRating4.setSelected(true);
        jCheckBoxSelectRating4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/4starU.png"))); // NOI18N
        jCheckBoxSelectRating4.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/4starC.png"))); // NOI18N

        jCheckBoxSelectRating5.setSelected(true);
        jCheckBoxSelectRating5.setToolTipText("");
        jCheckBoxSelectRating5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/5starU.png"))); // NOI18N
        jCheckBoxSelectRating5.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/5star.png"))); // NOI18N
        ...
        jCheckBoxSelectUpdate.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/update.png"))); // NOI18N
        ...
        jPanelSelectTracksLayout.setVerticalGroup(
            ...
            .addGroup(jPanelSelectTracksLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jScrollPaneSelect, javax.swing.GroupLayout.DEFAULT_SIZE, 223, Short.MAX_VALUE)
                .addGap(8, 8, 8)
