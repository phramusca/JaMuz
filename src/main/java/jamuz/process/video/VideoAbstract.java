...
//                    fileInfo.setStatus(Inter.get("Msg.Video.ErrorUpdatingDb"));
	...
	protected String getStreamDetails4Filename(FileInfoVideo file) {
        ...
        streamDetails=streamDetails.isBlank()?"":" ["+file.getVideoStreamDetails()+"]";
