 ...
 */
public class DialogBookExport extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public DialogBookExport(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void displayOptions() {
        jTextDestination.setText(Jamuz.getOptions().get("book.destination"));
    }
    
    private void setOptions() {
        Jamuz.getOptions().set("book.destination", jTextDestination.getText());
    }
