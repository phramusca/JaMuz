...
public class PanelSync extends javax.swing.JPanel {
    ...
    public void initExtended(Frame parent) {
		this.parent = parent;
        icons.add(new ImageIcon(getClass().getResource("/icons/delete.png")));
        icons.add(new ImageIcon(getClass().getResource("/icons/add.png")));
        icons.add(new ImageIcon(getClass().getResource("/icons/cancel.png")));
